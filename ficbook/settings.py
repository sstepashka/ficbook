# Django settings for ficbook project.
...
SECRET_KEY = '4cdoa9xsf)=dxs)()gazv*j!guk!v4166cx0b@*g6&amp;px@lrz1@'
...
ROOT_URLCONF = 'ficbook.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ficbook.wsgi.application'
